...
| 维度 | 说明 |
|------|------|
| **信息价值** | 内容是否提供了独特的见解、知识或信息？信息密度是否高？ |
| **情感共鸣** | 内容是否能引发观众的强烈情感（如喜悦、愤怒、好奇、共鸣）？观点是否鲜明？ |
| **传播潜力** | 内容是否包含易于传播的"金句"或有趣的"梗"？是否容易引发讨论和分享？ |
| **结构完整性** | 话题的讨论是否逻辑清晰、有始有终？ |
...
1. **综合评分 (`final_score`)**: 基于上述四大核心原则，对每个话题给出一个 **0.0到1.0之间** 的最终分数。分数应能体现其成为"爆款"的综合潜力。
2. **推荐理由 (`recommend_reason`)**: 为每个话题撰写一句 **15-30字** 的推荐理由。理由需要精准、诱人，能体现话题最核心的亮点。
